...
import { addSuperAdminDriver, updateSuperAdminDriver, getSingleDriver } from "../../../features/SuperAdminSlice/SuperAdminSlice";
...
const AddDriverForm = () => {
  ...
  const fetchDriverData = async () => {
    const result = await dispatch(getSingleDriver(id));
    ...
    if (result.meta.requestStatus === "fulfilled") {
      ...
      setFormData({
        ...
        password: "",
        confirmPassword: "",
        licensePhoto: d.licensePhoto || null,
      });
    } else {
      showToast(result.payload || "Failed to fetch driver data", "error");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.municipality.trim()) errors.municipality = true;
    if (!formData.validUntil.trim()) errors.validUntil = true;
    if (!isEditMode) {
    ...
    fd.append("municipality", formData.municipality);
    fd.append("validUntil", formData.validUntil);
    if (!isEditMode && formData.password) {
      fd.append("password", formData.password);
    }


    if (formData.licensePhoto && typeof formData.licensePhoto !== "string") {
      fd.append("licensePhoto", formData.licensePhoto);
    }
    ...
    if (isEditMode) {
      res = await dispatch(updateSuperAdminDriver({ id, formData: fd }));
    } else {
      res = await dispatch(addSuperAdminDriver(fd));
    }
    ...
    if (res.meta.requestStatus === "fulfilled") {
      ...
      showToast(res.payload || "Failed to add driver", "error");
    }
  };
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`w-full px-3 py-2.5 mt-1 text-sm rounded-xl outline-none text-[#718EBF]
    focus:ring-1 focus:ring-[#DFEAF2]
    border ${fieldErrors.fullName ? "border-red-500 bg-red-50" : "border-gray-200"}`}
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`w-full px-3 py-2.5 mt-1 text-sm rounded-xl outline-none text-[#718EBF]
    focus:ring-1 focus:ring-[#DFEAF2]
    border ${fieldErrors.email ? "border-red-500 bg-red-50" : "border-gray-200"}`}
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`w-full px-3 py-2.5 mt-1 text-sm rounded-xl outline-none text-[#718EBF]
    focus:ring-1 focus:ring-[#DFEAF2]
    border ${fieldErrors.phone ? "border-red-500 bg-red-50" : "border-gray-200"}`}
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              type="text"
              name="licenseNumber"
              placeholder="DL-4521-9987"
              value={formData.licenseNumber}
              onChange={handleChange}
              className={`w-full px-3 py-2.5 mt-1 text-sm rounded-xl outline-none text-[#718EBF]
    focus:ring-1 focus:ring-[#DFEAF2]
    border ${fieldErrors.licenseNumber ? "border-red-500 bg-red-50" : "border-gray-200"}`}
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`w-full px-3 py-2.5 mt-1 text-sm rounded-xl outline-none text-[#718EBF]
    focus:ring-1 focus:ring-[#DFEAF2]
    border ${fieldErrors.municipality ? "border-red-500 bg-red-50" : "border-gray-200"}`}
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`w-full px-3 py-2.5 mt-1 text-sm rounded-xl outline-none text-[#718EBF]
    focus:ring-1 focus:ring-[#DFEAF2]
    border ${fieldErrors.validUntil ? "border-red-500 bg-red-50" : "border-gray-200"}`}
            />
          </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="relative">
                  <input
                    ...
                    autoComplete="off"
                    onChange={handleChange}
                    className={`w-full px-3 py-2.5 pr-10 mt-1 text-sm rounded-xl outline-none text-[#718EBF]
border ${fieldErrors.password ? "border-red-500 bg-red-50" : "border-gray-200"}`}
                  />
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-3 py-2.5 pr-10 mt-1 text-sm rounded-xl outline-none text-[#718EBF]
border ${fieldErrors.confirmPassword ? "border-red-500 bg-red-50" : "border-gray-200"}`}
                  />
