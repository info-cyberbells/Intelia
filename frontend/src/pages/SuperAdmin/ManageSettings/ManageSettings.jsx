...
import { changeSuperAdminPassword, fetchSuperAdminProfile, updateSuperAdminDetails } from "../../../features/SuperAdminSlice/SuperAdminSlice";
...
const ManageSettings = () => {
  ...
  const handleSave = (e) => {
    ...
    dispatch(updateSuperAdminDetails(formDataToSend))
      .unwrap()
      .then(() => {
