...
import { fetchOwnerNotifications } from "../../features/notifications/notificationSlice";
...
const OwnerNotificationModal = ({ isOpen, onClose }) => {
    ...
    useEffect(() => {
        if (isOpen) dispatch(fetchOwnerNotifications());
    }, [isOpen, dispatch]);
        ...
        <div className="fixed inset-0 z-[9999] font-[Inter] flex items-start justify-end bg-transparent">
            ...
            >
                ...
                <div className="flex justify-between items-center mb-2">
                    <h2 className="text-base font-semibold text-[#303030]">Owner Notification</h2>
...
export default OwnerNotificationModal;
